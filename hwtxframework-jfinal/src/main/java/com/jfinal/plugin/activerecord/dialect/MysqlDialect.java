...
public class MysqlDialect extends Dialect {
	...
	//实际是配合datatable控件
	public void forPaginateByOffset(StringBuilder sql, int offset, int number, String select, String sqlExceptSelect) {
		sql.append(select).append(" ");
		sql.append(sqlExceptSelect);
		sql.append(" limit ").append(offset).append(", ").append(number);
	}
}
