...
public class TableMapping {
	...
	private final Map<String, Table> modelToTableMap = new HashMap<String, Table>();
	...
	public void putTable(Table table) {
		modelToTableMap.put(table.getModelClass().getName(), table);
	}
	
	@SuppressWarnings("rawtypes")
	public Table getTable(Class<? extends Model> modelClass) {
		Table table = modelToTableMap.get(modelClass.getName());
		if (table == null)
