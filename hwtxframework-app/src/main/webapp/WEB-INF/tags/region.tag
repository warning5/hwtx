...
<%@ attribute name="province_value" type="java.lang.String" required="true" description="省份值" %>
<%@ attribute name="city_value" type="java.lang.String" required="true" description="城市值" %>
<%@ attribute name="area_value" type="java.lang.String" required="true" description="地区值" %>
