...
<link rel="stylesheet" href="/static/jquery-validate/css/screen.css">
<script src="/static/jquery-validate/js/jquery.validate.min.js" type="text/javascript"></script>
<script src="/static/jquery-validate/js/messages_zh.js" type="text/javascript"></script>
<script>
