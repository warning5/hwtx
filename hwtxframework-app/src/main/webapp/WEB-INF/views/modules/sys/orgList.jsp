...
<script src="/static/resource/js/olist.js"></script>
			...
			<div class="tab-content padding-10" id="myTabContent1">
				<div class="row">
					...
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-6 orgboard u-text">
						...
						<form id="orgForm" method="post" action="${ctx}/sys/org/save" class="smart-form"
							onsubmit="return ajaxSubmit(this,'json',saveCallback)">
							<fieldset>
								<input type="hidden" name="save.type" id="save_type" /> <input
									type="hidden" name="sysOrg.orgId" id="sysOrg_orgId" /> <input
									type="hidden" name="sysOrg.pid" id="sysOrg_pid" />
								<div class="row">
									...
									<section class="col col-6">
										...
										<label class="input">
											<a href="#" class="btn btn-success btn-sm" id="checkUser"><i class="fa fa-user"></i> 查看</a>
										</label>
									</section>
									<section class="col col-6">
										<label class="input">
