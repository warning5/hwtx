    ...
    $(document).ready(function () {
        ...
        $('#container').jstree({
            ...
            $.ajax({
                type: 'post',
                dataType: "text",
                url: '${ctx}/sys/role/delete?id=' + data.node.id,
                cache: false,
                success: function (content) {
            ...
            <div class="tab-content padding-10" id="myTabContent1">
                ...
                <div id="s1" class="tab-pane fade in active">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-6" id="roleContent"></div>
                    </div>
                </div>
