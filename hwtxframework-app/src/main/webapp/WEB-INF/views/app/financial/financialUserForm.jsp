...
<script>
    $(document).ready(function () {
        $("#financialInputForm").validate({
            submitHandler: function () {
                ajaxSubmit($("#financialInputForm"), 'json', saveCallback);
            }
        });

        $("#sb").click(function () {
            $("#financialInputForm").submit();
        })
    });
    ...
    <div class="jarviswidget" id="wid-id-8" data-widget-editbutton="false"
        ...
        <div>
            ...
            <div class="widget-body no-padding">
                <form action="${ctx}/app/financial/saveUser" method="post" id="financialInputForm"
                      class="smart-form">
                    ...
                    <div class="row">
                        <section class="col col-10">
                            <label class="control-label">金融机构</label>
                            <label class="select">
                                <select name="userOrg">
                                    <c:if test="${orgs == null }">
