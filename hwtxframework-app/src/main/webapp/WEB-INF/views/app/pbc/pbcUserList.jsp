...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#fuserTable').dataTable({
            ...
            "sAjaxSource": "${ctx}/app/pbc/user_data",
            "sServerMethod": "POST",
            "iDisplayLength": 25,
            ...
            "aoColumns": [
                ...
                { "mData": "userId", "bSortable": false,
                    "mRender": function (data, type, full) {
                        return '<a onclick="editAction(this)" href="#" url="${ctx}/app/pbc/showEditUser?id=' +
                                full.userId + '&userOrg=' + full.orgId + '">修改</a>&nbsp;&nbsp;' +
                                '<a onclick="delAction(this)" href="#" url="${ctx}/app/pbc/deleteUser?ids=' +
        ...
        $("#usera").click(function () {
            HWTX.gDialogCreate('添加用户', '${ctx}/app/pbc/showAddUser', {}, 400, 280);
        });
    });
</script>
        ...
        <div>
            ...
            <div class="widget-body no-padding">
                <div class="widget-body-toolbar">
                    <form action="${ctx}/app/pbc/user" method="post" id="userForm"
